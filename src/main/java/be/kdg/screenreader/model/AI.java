...
public class AI {
    ...
    public void play(boolean isBiggerBoard) {
        if(isBiggerBoard){
            eliminateBiggerBoard(GAME.boardC.getQuestion().getIndex());
        }else{
            eliminateNormalBoard(GAME.boardC.getQuestion().getIndex());
        }
    }
    ...
    public void eliminateBiggerBoard(int index){
        for (Person person : GAME.boardC.getNEW_PEOPLE()) {
            switch (index) {
                case 0 -> {
                    if (isAnswerHumanQuestion()) {
                        if (person.getSex().equals(Sex.MALE)) {
    ...
    public void checkCounter(boolean isBiggerBoard) {
        resetCounter();
        if (isBiggerBoard) {
            for (Person person : GAME.boardC.getNEW_PEOPLE()) {
